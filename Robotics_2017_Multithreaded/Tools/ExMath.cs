/* ===================================================================================
 * Code taken from samples available in http://LoveElectronics.co.uk and added minor
 * usable function to translates radians to degrees by Zakie Mashiah
 * ===================================================================================
...
namespace Test_Bot_Multithread.Tools
    {
        /// <summary>
        ...
        public static class ExMath
        {
            ...
            /// <returns></returns>
            public static double Love_Sqrt(double number)
            {
            ...
            {
                double result = (360 * d) / (2 * ExMath.PI);
                while (result < 0)
                    result += 360;
                while (result >= 360)
                    result -= 360;
